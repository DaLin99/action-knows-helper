<template>
  <view class="detail">
    ...
    <uni-list class="info-list">
      <uni-list-item
        title="失物名称"
        :rightText="itemDetail.title"
      ></uni-list-item>
      <uni-list-item
        title="丢失时间"
        :rightText="itemDetail.time"
      ></uni-list-item>
      <uni-list-item
        title="丢失地点"
        :rightText="itemDetail.place"
      ></uni-list-item>
      <uni-list-item
        title="发布时间"
        :rightText="itemDetail.publishDate"
      ></uni-list-item>
      <uni-list-item
        title="拾到者"
        :rightText="itemDetail.publisher"
      ></uni-list-item>
      <uni-list-item
        title="联系微信"
        :rightText="itemDetail.wechat"
      ></uni-list-item>
    ...
    <button
      v-if="userInfo.openid === itemDetail.publisherId"
      type="primary"
      class="mt40"
      @click="edit"
    >
    ...
    <button v-else type="primary" class="mt40" @click="cancelFavorite">
      取消收藏
    </button>
  </view>
</template>
